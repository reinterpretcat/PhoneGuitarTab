...
namespace PhoneGuitarTab.Core.Services
{
    ...
    public class SkyDriveService : ICloudService
    {
        ...
        private LiveConnectSession _liveSession;
            // NOTE refactor class to get existing session from outside if it's necessary

        private readonly SkyDriveService.Cache _cache = new SkyDriveService.Cache();
        ...
        private class Cache
        {
            ...
            private Dictionary<string, Tuple<DateTime, object>> _cacheMap =
