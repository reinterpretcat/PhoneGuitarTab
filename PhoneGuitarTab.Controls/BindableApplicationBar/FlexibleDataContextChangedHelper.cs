...
namespace PhoneGuitarTab.Controls
{
    ...
    internal class FlexibleDataContextChangedHelper<T> where T : FrameworkElement
    {
        ...
        ///     indicates the FlexibleDataContextChangedHelper instance responsible for routing the callback that is executed when
        ///     the control's DataContext changes.
        /// </summary>
        ...
        ///     the control's DataContext changes.
        /// </summary>
        public static void SetFlexibleDataContextChangedHandler(DependencyObject d,
            FlexibleDataContextChangedHelper<T> value)
        {
